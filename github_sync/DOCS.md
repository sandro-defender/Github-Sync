...
The panel itself is a modern single-page app served by this app over Ingress — it includes mapping search, status dots, filter chips on update checks, a file-tree editor for the ignore rules, toasts and a mobile-friendly layout, and it follows your system light/dark preference. See the repository [README](https://github.com/sandro-defender/Github-Sync) for mapping instructions, ignore rules, and safety notes.
